...
const Login = () => {
  ...
  return (
    <div className={`flex w-full min-w-0 min-h-dvh max-w-full flex-col overflow-hidden rounded-[36px] bg-sich-surface shadow-sich-card sm:mx-auto ${previousRoute === '/register' ? 'animateRight' : ''}`}>
      <div className="flex flex-col">
        <SichBadge/>
        <div className="flex flex-col mt-8 px-6">
          <Title text="Bem-vinda de volta" />
          <span className="text-sich-label text-[11px]">Entre para acessar seus agendamentos e benefícios.</span>
          <form className="flex flex-col" onSubmit={onSubmit}>
            <div className="flex-col flex gap-2.5 mt-6">
